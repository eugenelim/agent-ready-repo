...
4. **For credentialed skills** (calls an authenticated external API on the user's behalf), follow the how-to [`guides/credential-brokers/how-to/add-a-credentialed-skill.md`](guides/credential-brokers/how-to/add-a-credentialed-skill.md) — the security rules around credential handling are non-negotiable; [`packs/atlassian/.apm/skills/jira/`](packs/atlassian/.apm/skills/jira/) is a runnable reference consumer.
