...
3. **For credentialed skills**, follow [`guides/credential-brokers/how-to/add-a-credentialed-skill.md`](guides/credential-brokers/how-to/add-a-credentialed-skill.md); [`packs/atlassian/.apm/skills/jira/`](packs/atlassian/.apm/skills/jira/) is a reference consumer.
