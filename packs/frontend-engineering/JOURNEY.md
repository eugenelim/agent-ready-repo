...
contract:
  ...
  youProvide: "A surface brief, existing page, or completed implementation, plus any product constraints, routes, the breakpoints the surface declares, the supported minimum width if the surface has one, viewports, design references, and available performance data."
