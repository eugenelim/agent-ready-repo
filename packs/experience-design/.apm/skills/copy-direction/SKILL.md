...
Turns a vague "how should our marketing copy sound" into a small set of **named, ranked copy voice goals**, each grounded in a stable referent, and records them — along with arbitration rules — in a copy-direction doc the rest of the build references. The doc is the durable artifact: every later copy choice on this surface points back to a goal and its referent rather than relitigating voice. This skill is the copy twin of `creative-direction`: same interrogation rhythm applied to what the product *says* on a specific surface rather than how it *looks*.
...
- **Producing SEO content, advertising copy templates, or brand identity documentation.** This skill names copy direction for marketing/acquisition copy voice and positioned copy for a specific surface. SEO keyword targeting is out of scope for this skill. Full brand identity docs and advertising copy templates are wider than this skill's scope; push back and redirect.
