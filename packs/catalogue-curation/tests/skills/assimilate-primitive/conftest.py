"""Resolve the assimilate-primitive skill's runtime tree for the tests that exercise it.
...
SKILL = Path(__file__).resolve().parents[3] / ".apm" / "skills" / "assimilate-primitive"
