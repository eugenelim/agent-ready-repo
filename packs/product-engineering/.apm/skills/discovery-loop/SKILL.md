...
(`decompose-intent`), *UX/experience* (`map-customer-journey`, `blueprint-service`,
`map-screen-flow`, `voice-and-microcopy` — if installed), *tech*
...
- **Optional detect-and-degrade:** the `research` / `experience` / `architect`
