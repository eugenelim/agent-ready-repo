...
The `/research` pack rests on seven convergent disciplines from mature
...
and `/research`'s ≥3 independent-sources rule.
...
ACH's evidence-against column) and as a final-step gate in `/research`
