"""Pytest coverage for the new-ADR ordinal allocator."""
...
SPEC = importlib.util.spec_from_file_location("new_adr_next_ordinal", SCRIPTS / "next-ordinal.py")
MODULE = importlib.util.module_from_spec(SPEC)
assert SPEC.loader is not None
SPEC.loader.exec_module(MODULE)

RFC_SCRIPT = SCRIPTS.parents[1] / "new-rfc/scripts/next-ordinal.py"
...
def test_shipped_adr_and_rfc_scripts_are_byte_identical() -> None:
    ...
    assert (SCRIPTS / "next-ordinal.py").read_bytes() == RFC_SCRIPT.read_bytes()
