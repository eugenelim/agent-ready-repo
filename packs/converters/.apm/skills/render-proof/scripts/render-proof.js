...
async function renderProof(md, opts) {
  ...
  const wrapped = renderToStaticMarkup(
    React.createElement('div', { dangerouslySetInnerHTML: { __html: preRendered } }) // nosemgrep: typescript.react.security.audit.react-dangerouslysetinnerhtml.react-dangerouslysetinnerhtml // preRendered is sanitized by renderMarkdown before the fallback render
  );
