...
def test_crawler_surfaces_do_not_recommend_the_jira_entry() -> None:
    surfaces = _surface_text().lower()
    for jira_specific in ("jira.py", "jira skill", "check --register"):
        assert jira_specific not in surfaces
