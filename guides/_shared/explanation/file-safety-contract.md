...
- [`docs/architecture/pack-layout.md` § The source-of-truth split](../../../docs/architecture/pack-layout.md#the-source-of-truth-split) — the internal mirror of the Tier model, for contributors.
