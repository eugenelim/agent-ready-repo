...
For the catalogue of what the pack ships, see the [reference](../reference/desk-research-pack.md). For how to use it, see the [how-to guide on pipelines](../how-to/research-pipelines.md) or the [first-session tutorial](../tutorials/desk-research-first-session.md).
