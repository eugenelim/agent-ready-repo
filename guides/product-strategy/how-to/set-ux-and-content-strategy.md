...
- **Jaime Levy's four tenets** of UX strategy — the business-strategy,
  value-innovation, validated-user-research, and frictionless-UX framing, as the
  2021 second edition of *UX Strategy* names them (the 2015 first edition called
  the fourth tenet killer UX design);
...
`define-content-strategy` works this pack's own four-part composite — **Purpose**,
