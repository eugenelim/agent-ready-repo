...
#
# The second rebase also caught a collision the floor alone does not: this slice
# had claimed 2.24.4, and main then shipped 2.24.4 as a different code state.
