...
# STUB: duplicate integration IDs within one pack error
...
# STUB: skill consumer ref missing in declaring pack errors
...
# STUB: agent consumer ref missing in declaring pack errors
...
# STUB: skill consumer ref resolved when file exists → passes
...
# STUB: self-target (entry.pack == declaring pack name) errors
...
# STUB: absent target pack does NOT produce an error
...
# STUB: provider ref missing when target is present in catalogue errors
...
# STUB: command consumer ref missing in declaring pack errors
...
# STUB: command consumer ref present passes
...
# STUB: hook consumer ref missing (hooks dir absent) errors
...
# STUB: hook consumer ref present passes
