...
Confirms:
  ...
  - `guides/_shared/reference/README.md` links to the new page.
"""
...
HOWTO_INSTALL_FROM_CLONE = (
    REPO_ROOT / "guides" / "_shared" / "how-to" / "install-agentbundle-from-clone.md"
)
...
def test_reference_readme_links_to_agentbundle_page() -> None:
    ...
    assert "agentbundle.md" in body, (
        "guides/_shared/reference/README.md should link to the new "
        "agentbundle.md page."
    )
