...
PACK_SCHEMA_PATH = (
    PACKAGE_ROOT / "agentbundle" / "_data" / "pack.schema.json"
)
...
"""
        ...
        self.assertEqual(
            errors,
            [],
            "schema rejected valid governance-extras example:\n" + "\n".join(errors),
        )
...
"""
        ...
        self.assertEqual(
            errors,
            [],
            "schema rejected pack without dependencies.required:\n"
            + "\n".join(errors),
        )
...
"""
        ...
        self.assertEqual(
            errors,
            [],
            "schema rejected pack without any dependencies:\n" + "\n".join(errors),
        )
...
"""
        ...
        self.assertEqual(
            errors,
            [],
            "schema rejected valid relative-path seeds:\n" + "\n".join(errors),
        )
