...
class TestFrameSizeCap:
    ...
    def test_oversized_frame_discarded_and_error_returned(self) -> None:
        pytest.skip("STUB: AC16a — send 1 MiB + 1 byte line; assert error response code -32600")

    def test_subsequent_frame_processed_after_oversized_quarantine(self) -> None:
        pytest.skip("STUB: AC16a — oversized frame followed by valid frame; valid frame handled")
...
class TestMalformedJSON:
    ...
    def test_malformed_json_returns_parse_error(self) -> None:
        pytest.skip('STUB: AC16b — send "{bad json"; assert error code -32700')

    def test_valid_frame_after_malformed_is_processed(self) -> None:
        pytest.skip("STUB: AC16b — malformed followed by valid initialize; valid handled")
...
class TestUnknownRequestId:
    ...
    def test_unknown_request_id_discarded(self) -> None:
        pytest.skip("STUB: AC16c — send result with id not in request_map; no exception raised")
...
class TestInitializeHandshake:
    ...
    def test_initialize_response_contains_tools_key(self) -> None:
        pytest.skip('STUB: AC1 — send initialize; assert result["tools"] is a list')

    def test_tools_list_includes_workspace_status(self) -> None:
        pytest.skip("STUB: AC1 — tools/list response contains workspace_status")

    def test_tools_list_includes_elicit(self) -> None:
        pytest.skip("STUB: AC1 — tools/list response contains elicit")

    def test_server_capabilities_has_no_elicitation(self) -> None:
        pytest.skip('STUB: AC13 — ServerCapabilities never includes "elicitation"')
...
class TestStdinClose:
    ...
    def test_process_exits_within_5s_on_stdin_close(self) -> None:
        pytest.skip("STUB: AC22 — launch workspace_mcp.py as subprocess; close stdin; assert exits within 5 s")
