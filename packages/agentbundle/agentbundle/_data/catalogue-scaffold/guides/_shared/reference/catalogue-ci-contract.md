...
- **`agentbundle` reference** — install the CLI, install a pack, configure the
  default adapter, source-resolution chain, environment variables. See the
  `agentbundle.md` reference guide in your local guides tree, or the project
  docs site.
- **Catalogue format** — what makes a directory a valid catalogue, schema
  contracts, and validation. See the `catalogue-format.md` reference guide in
  your local guides tree, or the project docs site.
