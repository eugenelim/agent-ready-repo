...
| Derivation state (schema 3) | `.agentbundle/self-host-state.json` | `catalogue init --preset self-hosted` | Stale-path removal and recorded recipe defaults on a later init run |
