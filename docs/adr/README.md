...
| 0101 | [A Semgrep exclusion may be path-scoped for scanner performance, if it states its residual and carries a retirement trigger](0101-path-scoped-semgrep-exclusion-for-scanner-performance.md) | Accepted |
| 0098 | [Pack tests are isolated by default, grouped only by a declared compatibility class](0098-pack-test-isolation-by-default-with-declared-compatibility-classes.md) | Accepted |
