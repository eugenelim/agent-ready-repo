...
- **Guide update:** `guides/credential-brokers/how-to/add-a-credentialed-skill.md`
...
- **2026-05-31 (Approver: eugenelim) — § 9's two teaching skills are
  ...
  **Why the original framing was over-built.** The architectural enforcement
  ...
  the Diátaxis how-to (`guides/credential-brokers/how-to/add-a-credentialed-skill.md`)
