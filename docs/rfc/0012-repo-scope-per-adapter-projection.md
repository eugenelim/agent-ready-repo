...
- **[Bun workspaces](https://bun.com/guides/install/workspaces)** — workspace installs land at project-local paths; redistribution is a separate verb. Same split.
