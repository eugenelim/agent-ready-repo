...
| Documentation | `guides/credential-brokers/how-to/add-a-credentialed-skill.md` | Diátaxis how-to walking through the contract |
...
- **Guide: `guides/credential-brokers/how-to/add-a-credentialed-skill.md`** — the
