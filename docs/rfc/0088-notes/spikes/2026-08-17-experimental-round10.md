...
**Status:** partial. Three of four named tasks are complete; the round is written up
...
takes this note as part of its corpus: **83 figures derived, zero wrong, zero
claimed-nowhere**.

**Each of the sixteen facts added for round 10 was mutation-tested individually** —
mutate the artifact field it guards, confirm the fact fails, restore. All sixteen
