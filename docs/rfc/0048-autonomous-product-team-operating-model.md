...
connective skills (`map-customer-journey`, `blueprint-service`, `map-screen-flow`) +
...
| 4b | Convergence — UX & process | `discovery-lead` | `map-customer-journey` → `map-screen-flow` (+ per-screen briefs) → `blueprint-service`; `map-internal-process` (as-is/to-be) where the initiative touches internal operations (experience) | journey · screen inventory + briefs · service blueprint · internal process flow | — |
...
- **2026-06-26 — child-1 (the `experience` pack, [RFC-0050](0050-the-experience-pack.md))
  ...
  replacement list (RFC-0050 D2/D4); **(ii)** `map-screen-flow` ships a **cross-brief
