# RFC-0100: Adopter- and org-supplied grounding for platform, framework, and verification context
...
- **Renumbered:** issued as RFC-0047 and moved to RFC-0100 on 2026-09-12. Two proposals had been accepted under 0047 independently; the one that reached the default branch first keeps the ordinal. Only this record's identifier changed — its proposal text is unaltered.
