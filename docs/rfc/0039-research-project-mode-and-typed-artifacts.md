...
- *Live docs (5)* — 3 guides under `guides/research/` (`how-to/research-pipelines`, `reference/research-pack`, `tutorials/research-first-session`) + `guides/_shared/how-to/run-a-full-inception.md` + `docs/specs/research-pack/plan.md`.
