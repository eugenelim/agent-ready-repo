...
- **Partly answered on 2026-09-13** by the audit this bullet asks for, recorded in [the fragmentation spike](changelog-fragmentation-spike.md#conflict-rate-measured-2026-09-13): over 30 days, 39 of the 43 rebases that had to replay a `docs/product/changelog.md` edit conflicted, and 20 of 51 for `workspace.toml`; abandoned branches contributed none on the changelog. What remains open is the third term — how many resolutions were performed *incorrectly* — which a textual replay cannot see.
