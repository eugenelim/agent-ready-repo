...
concept_path: concepts/system-shapes/client-server.md
confidence: moderate
lifecycle: living
review_by: 2027-08-21
---
# Client/server systems — source packet

## Material claims

| Claim | Synthesis | Sources |
| --- | --- | --- |
| SS-C1 | Client/server assessment requires trust placement, identity, version skew, network failure, caching/synchronization, data ownership, and rollout compatibility. | S1, S2, S3 |
| SS-C1b | A shape label is a routing hypothesis; representative runtime, data, delivery, and failure paths must confirm its material boundaries. | S1, S2, S3 |
