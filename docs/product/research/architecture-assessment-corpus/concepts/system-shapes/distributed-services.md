...
concept_path: concepts/system-shapes/distributed-services.md
confidence: moderate
lifecycle: living
review_by: 2027-08-21
---
# Distributed services — source packet

## Material claims

| Claim | Synthesis | Sources |
| --- | --- | --- |
| SS-D1 | Service boundaries should buy a named autonomy or isolation benefit and must address partial failure, data authority, identity, observability, and operational cost. | S1, S2, S3 |
| SS-D1b | A shape label is a routing hypothesis; representative runtime, data, delivery, and failure paths must confirm its material boundaries. | S1, S2, S3 |
