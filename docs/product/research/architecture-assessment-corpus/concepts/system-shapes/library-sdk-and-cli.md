...
concept_path: concepts/system-shapes/library-sdk-and-cli.md
confidence: moderate
lifecycle: living
review_by: 2027-08-21
---
# Library, SDK, and CLI systems — source packet

## Material claims

| Claim | Synthesis | Sources |
| --- | --- | --- |
| SS-L1 | Embedded and command-line products are primarily constrained by public behavior, host assumptions, distribution, compatibility, and failure/upgrade semantics. | S1, S2, S3 |
| SS-L1b | A shape label is a routing hypothesis; representative runtime, data, delivery, and failure paths must confirm its material boundaries. | S1, S2, S3 |
