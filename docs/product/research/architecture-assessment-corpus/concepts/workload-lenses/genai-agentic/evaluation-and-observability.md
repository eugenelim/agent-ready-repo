...
concept_path: concepts/workload-lenses/genai-agentic/evaluation-and-observability.md
confidence: high
lifecycle: living
review_by: 2027-08-21
---
# Agent evaluation and observability — source packet

## Material claims

| Claim | Synthesis | Sources |
| --- | --- | --- |
| WL-A5 | Agent evidence should correlate run/step/model/knowledge/tool/policy/state/version/cost signals and evaluate consequential operational and quality scenarios. | S1, S2, S3 |
| WL-A5b | Repository structure and provider labels can trigger this lens but cannot prove runtime, policy, isolation, or recovery behavior without representative path evidence. | S1, S2, S3 |
