...
concept_path: concepts/quality-lenses/reliability-resilience-and-recovery.md
confidence: high
lifecycle: living
review_by: 2027-08-21
---
# Reliability, resilience, and recovery — source packet

## Material claims

| Claim | Synthesis | Sources |
| --- | --- | --- |
| QL-R1 | Reliability assessment must trace named failure scenarios through isolation, state, side effects, detection, recovery objectives, and exercised recovery. | S1, S2, S3 |
| QL-R1b | Structural proxies focus investigation but do not establish the quality outcome without scenario and exercised evidence. | S1, S2, S3 |
