...
concept_path: concepts/quality-lenses/cost-and-resource-efficiency.md
confidence: high
lifecycle: living
review_by: 2027-08-21
---
# Cost and resource efficiency — source packet

## Material claims

| Claim | Synthesis | Sources |
| --- | --- | --- |
| QL-C1 | Cost decisions require allocation to useful workload outcomes and explicit quality, risk, option, contract, and people-cost trade-offs. | S1, S2, S3 |
| QL-C1b | Structural proxies focus investigation but do not establish the quality outcome without scenario and exercised evidence. | S1, S2, S3 |
