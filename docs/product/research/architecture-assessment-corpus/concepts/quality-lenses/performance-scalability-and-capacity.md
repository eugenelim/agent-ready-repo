...
concept_path: concepts/quality-lenses/performance-scalability-and-capacity.md
confidence: high
lifecycle: living
review_by: 2027-08-21
---
# Performance, scalability, and capacity — source packet

## Material claims

| Claim | Synthesis | Sources |
| --- | --- | --- |
| QL-P1 | Performance and capacity claims require representative workload distributions, end-to-end targets, limiting mechanisms, and sensitivity to future demand. | S1, S2, S3 |
| QL-P1b | Structural proxies focus investigation but do not establish the quality outcome without scenario and exercised evidence. | S1, S2, S3 |
