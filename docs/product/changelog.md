...
## [catalogue-curation][0.4.3] — 2026-08-27
...
- Escaped hostile Markdown display metadata in generated indexes and added a
  forced repeated-render regression proving nondeterministic output fails with
  `OKF012` and leaves no partial result.
