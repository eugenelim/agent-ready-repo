...
Five capability members, one per clause of the lagging outcome above. Two are
minted. The intent counts are how much of the territory each member holds
today, not what defines it.
