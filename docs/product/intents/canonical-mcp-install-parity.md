...
- Same-wave parity covers source, validation, normalized model, capable direct-install adapters, claimed routes, diagnostics, guides, and fail-closed security controls.
