...
The company OS has a charter decision that determines whether a dedicated growth strategy pack can be scoped and proposed.

## Opportunity

Growth strategy was intentionally excluded from the product-strategy v1 pack, and no later charter-scoping decision has been located.
