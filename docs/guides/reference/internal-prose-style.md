...
- **Soft-wrap guides.** Under `docs/guides/`, one line per paragraph, blank line between paragraphs, list items one line each. Older docs (README, the docs map) are hard-wrapped near 72 columns; match the file you're editing.
