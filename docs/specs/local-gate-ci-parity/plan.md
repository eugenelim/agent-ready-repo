...
- **Status:** Done (superseded in part by [ADR-0086](../../adr/0086-split-the-sast-gate-into-its-own-ci-job.md) — the AC3/AC3a/AC3b verdict case set; everything else stands) <!-- Drafting | Executing | Done -->
