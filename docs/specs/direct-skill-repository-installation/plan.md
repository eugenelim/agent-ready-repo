...
- Protected AgentBundle implementation changes carry `Engine-Change-RFC: RFC-0098`; this includes `packages/agentbundle/agentbundle/catalogue_tooling/file_safety.py` and `packages/agentbundle/agentbundle/catalogue_tooling/diagnostics.py`.
