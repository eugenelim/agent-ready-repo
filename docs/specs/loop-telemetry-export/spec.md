...
- **Constrained by:** [ADR-0112](../../adr/0112-loop-telemetry-sender-is-a-separately-installed-distribution.md)
...
| --- | --- | --- | --- | --- | --- |
| Decision rationale | Applicable — a sender outside every pack reverses stated current architecture | [`docs/adr/0112-loop-telemetry-sender-is-a-separately-installed-distribution.md`](../../adr/0112-loop-telemetry-sender-is-a-separately-installed-distribution.md) | spec owner | Accepted ADR naming the § 5.2 interpretation and the per-engine default | ADR merged and cited by `telemetry.md` |
...
a validated stub, because ADR-0112 makes the profile a TOML *file* at a path this
