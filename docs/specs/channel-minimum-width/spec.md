...
- **Channel disjointness (AC-0017):** TDD in the same module, swept over the derivation fixtures rather than stated per case, because the property is universal over inputs and a per-case assertion would let a new fixture arrive unchecked.
