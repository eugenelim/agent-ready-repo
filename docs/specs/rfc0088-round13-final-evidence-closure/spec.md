...
`r9-promote.sh` (T5), and one new `s3` driver (T6). A digest is re-recorded **only** after a
...
- Route every purge through the single manifested `s1/confined-remove.mjs` helper.
