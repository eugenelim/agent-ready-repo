...
- **Constrained by:** ADR-0108, RFC-0099
- **Brief:** none
- **Discovery:** none
- **Contract:** none
- **Shape:** mixed
...
| --- | --- | --- | --- | --- | --- |
| Decision rationale | Applicable; the split reverses part of an accepted design | `docs/adr/0108-intent-review-splits-well-formedness-from-assumption-attack.md` | maintainer | ADR Accepted, indexed in `docs/adr/README.md` | ADR exists and this spec cites it |
...
- [ ] `docs/specs/shaping-review-contracts/spec.md`, its `plan.md`, and
  ...
  `Status`-line pointer to ADR-0108 naming the superseded intent part, with no
  other line changed.
...
- Process: the `MALFORMED` field tokens are a closed set, extended from five to
  ...
  (source: user confirmation 2026-09-11; ADR-0108 decision item 1).
