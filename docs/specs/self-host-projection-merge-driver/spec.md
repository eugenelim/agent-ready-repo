...
| Release history | Not applicable | — | — | — | The change is maintainer-only: no consumer-visible outcome and no owning released artifact, and `docs/product/changelog.md` is released-artifact-scoped. `AGENTS.local.md` § Landing changes owns the procedure |
