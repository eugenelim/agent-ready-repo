...
- **Status:** Shipped <!-- Draft | Approved | Implementing | Shipped | Archived --> <!-- Phase 1 (headless) + Phase 2 (in-harness, RFC-0037 § Errata E2) both shipped; a Kiro-native ergonomic driver is an optional follow-on (docs/backlog.md) -->
- **Owner:** eugenelim
