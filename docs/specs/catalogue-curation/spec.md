...
**Open paths not yet exercised:** hook/script ingest (hook-confirm AC); re-sync RFC routing (Open→Amendment / Frozen→Erratum / Frozen+new→new RFC); anti-pattern detection (steering a misuse pattern); `propose-catalogue-pack` (any QA).
