...
**Tests:**
- `guides/research/tutorials/research-first-session.md` exists.
...
**Tests:**
- `guides/research/how-to/research-pipelines.md` exists.
...
**Tests:**
- `guides/research/reference/research-pack.md` exists.
...
**Tests:**
- `guides/research/explanation/research-methodology.md` exists.
