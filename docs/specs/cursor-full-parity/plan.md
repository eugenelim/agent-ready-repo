...
- **Status:** Done (superseded in part by [ADR-0040](../../adr/0040-route-cohort-skills-to-shared-agents-skills-home.md) — the `.cursor/skills/` skill home this plan projects now routes to the shared `.agents/skills/`; every other projection decision stands) <!-- Drafting | Executing | Done -->
