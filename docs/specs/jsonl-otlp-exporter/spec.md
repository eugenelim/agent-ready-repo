...
| Decision rationale | Not applicable — ADR-0112 already records why a separate distribution exists; this spec adds no reversal | — | — | — | — |
...
- **Conversion semantics — an owner decision, not a contract gap.** This spec
  ...
  **Settled 2026-09-13 by the ADR-0112 decision owner; this entry is closed.**
  The four answers are recorded in ADR-0112 with their reasons and are pinned by
