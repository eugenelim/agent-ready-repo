...
- **Status:** Shipped (superseded in part by [ADR-0040](../../adr/0040-route-cohort-skills-to-shared-agents-skills-home.md) — the skill home is now the shared `.agents/skills/`; note this also supersedes the *replacement* path named in the § banner below, `.github/skills/<name>/`, so read that banner through this line; every other projection decision stands) <!-- Draft | Approved | Implementing | Shipped | Archived -->
- **Owner:** eugenelim
