...
- **Status:** Shipped (superseded in part by ADR-0101 — the golden baseline's pin was amended once, with approval, when `runners-keep-suites-isolated` was replaced by the compatibility-class checks; everything else stands) <!-- Draft | Approved | Implementing | Shipped | Archived -->
- **Owner:** eugenelim
