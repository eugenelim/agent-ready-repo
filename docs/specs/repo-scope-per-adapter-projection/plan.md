...
- Goal-based grep: `guides/_shared/explanation/install-routes.md` mentions `--emit-install-routes` and the default per-IDE projection at repo scope.
...
- Edit `guides/_shared/explanation/install-routes.md` (per AC27) to note the default per-IDE projection at repo scope and the `--emit-install-routes` opt-in.
