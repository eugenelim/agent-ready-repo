...
Verification: goal-based — file exists at `guides/_shared/how-to/choose-a-tracker-integration.md`
...
Verification: goal-based — file exists at `guides/_shared/reference/tracker-vocabulary.md`
...
`_shared/reference/README.md`, `guides/README.md`, and `docs/product/changelog.md`.
