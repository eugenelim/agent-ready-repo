...
Base for every measurement below: `origin/main` at `325091a77`. Every figure here
...
so it can be re-run:
    ...
    git diff 74f9a4ac9 325091a77 -- packs/agent-skill-engineering/
...
authored and corrected inside one commit (`8bf10d843`); it is absent at that
...
All citations now name `8bf10d843`, verified reachable, and both claims re-checked
