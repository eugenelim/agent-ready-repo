...
6. **A worked example and a how-to guide** — `example-credentialed-skill`
   ...
   `docs/guides/credential-brokers/how-to/add-a-credentialed-skill.md` walks adopters
...
- [x] **AC31.** A Diátaxis how-to at
      `docs/guides/credential-brokers/how-to/add-a-credentialed-skill.md` walks an
