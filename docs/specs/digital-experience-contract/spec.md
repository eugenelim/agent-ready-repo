...
- **Status:** Shipped (superseded in part by ADR-0124 — the contract's frontend section is owned by `frontend-engineering` rather than `core`; everything else stands) <!-- Draft | Approved | Implementing | Shipped | Archived -->
- **Owner:** eugenelim
