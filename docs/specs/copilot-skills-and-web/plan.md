...
- **Status:** Done (superseded in part by [ADR-0040](../../adr/0040-route-cohort-skills-to-shared-agents-skills-home.md) — the `.github/skills/` and `.copilot/skills/` skill homes this plan retargets now route to the shared `.agents/skills/`; every other change stands) <!-- Drafting | Executing | Done -->
...
**Approach:**
- `guides/_shared/reference/adapter-support.md` — correct **all** copilot
...
- `guides/research/reference/research-pack.md` — besides any web-degradation note,
...
- `guides/research/tutorials/research-first-session.md` — remove the Copilot
...
- `docs/specs/README.md` — **(a)** add a `copilot-skills-and-web` entry to the
  ...
  file.
- `README.md` / `guides/_shared/reference/README.md` — only if they assert these
  specifics.
