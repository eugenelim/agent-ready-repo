...
- [x] The doc blast radius is reconciled to reflect SKILL.md skills +
  ...
  the headline cell): `guides/_shared/reference/adapter-support.md` — the Copilot
  ...
  to "plan around the no-web-tool caveat"; `guides/research/reference/research-pack.md`;
  `guides/research/tutorials/research-first-session.md`; `docs/architecture/agentbundle.md`;
