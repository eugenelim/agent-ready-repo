...
- 2026-09-20 — **That clean verdict no longer applies to this revision.** After approval, two owner decisions reversed the refusal semantics and then deferred the rename, and the contract has been revised through several review rounds since. Adversarial review's current verdict is outstanding. The approval above stands as the owner's authorisation to build; it is not evidence that the present revision has been reviewed clean, and this entry exists because an approval basis written once goes stale silently while still reading as current.
