...
- [x] **AC1 — Portable boundary.** The portable content consists of two
...
- [x] **AC2 — Progressive authoring.** The authoring workflow exposes exactly
...
- [x] **AC3 — Create and update outcomes.** `create` produces the smallest
...
- [x] **AC4 — Foundation availability.** Requests for `knowledge-provider`,
...
- [x] **AC5 — Review before optimize.** The review/optimize workflow begins
...
- [x] **AC6 — Workflow activation and behavior.** Four versioned foundation
...
- [x] **AC7 — Governed foundation corpus.** The raw OKF bundle is owned by this
...
- [x] **AC8 — Deterministic generated router.** The router and its indexes are
  ...
  contains.)
- [x] **AC9 — Router precision.** At least twenty predeclared foundation
...
- [x] **AC10 — Knowledge-surface discovery.** A consumer performs bounded,
...
- [x] **AC11 — Semantic provider request.** An explicit provider invocation
...
- [x] **AC12 — Semantic provider response.** The provider returns the matching
...
- [x] **AC13 — Provider absence and failure.** If no eligible provider exists,
...
- [x] **AC14 — Independent-provider confinement.** Any consumer integration
...
- [x] **AC15 — Language extension points.** The retrieval contract recognizes
...
- [x] **AC16 — Authentication isolation.** Provider discovery and invocation
...
- [x] **AC17 — Least authority.** Candidate skills, repository content,
...
- [x] **AC18 — Hostile-input confinement.** Every hostile metadata fixture
  ...
  properties.
- [x] **AC19 — Failure-mode evaluations.** Versioned fixtures cover missing and
...
- [x] **AC20 — Compiler prerequisites.** The canonical
...
- [x] **AC21 — External delivery wrapper only.** Any minimal manifest needed to
...
- [x] **AC22 — Release gate.** The M1 corpus/router and workflow behavior gates
