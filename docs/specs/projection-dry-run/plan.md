...
- **Files touched:** `packages/agentbundle/agentbundle/cli.py` (add `--dry-run`
  ...
  `guides/_shared/how-to/preview-install-or-upgrade.md` (new) +
  `guides/_shared/reference/agentbundle.md` (flag listing); `docs/product/changelog.md`.
...
**Touches:** guides/_shared/how-to/preview-install-or-upgrade.md, guides/_shared/reference/agentbundle.md, guides/_shared/how-to/README.md, docs/product/changelog.md

**Tests:** goal-based — one-liner checks (file exists, `grep` the flag name), not
a pytest module:
- `guides/_shared/how-to/preview-install-or-upgrade.md` exists, is listed in
...
- `guides/_shared/reference/agentbundle.md` lists `--dry-run` under both `install`
  and `upgrade`. [AC7]
