...
- [x] **AC9 — Docs suite updated:** `guides/atlassian/how-to/work-with-jira.md` has a "Write actionable stories" section including the right-sizing check; `guides/atlassian/reference/atlassian-skills.md` has entries for both new skills; `guides/atlassian/README.md` names both new skills; `guides/atlassian/explanation/atlassian-pack.md` has bullets for both new skills; `packs/atlassian/README.md` names both new skills.
