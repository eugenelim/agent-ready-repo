...
- Technical: Most regression tests for prefix violations use `assertRaises(safety.PathJailError)` or `rc != 0` without matching the error-message text. One test (`test_scope.py::test_write_jailed_user_scope_refuses_outside_prefix`) did match the old inline wording (`"allowed prefixes"`, `"scope 'user'"`) and was updated to the new canonical form during implementation. All other tests in `test_safety_repo_scope_prefixes.py:38–106` and `test_upgrade_cmd.py:755–777` do not match message text. (`test_safety_repo_scope_prefixes.py:38–106`, `test_upgrade_cmd.py:755–777`, `test_scope.py:171-172`, read 2026-07-23)
