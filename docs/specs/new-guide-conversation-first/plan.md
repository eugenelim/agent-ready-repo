...
- 4 new `should_trigger: false` entries (Jira story, Acme team blockers, README spelling, Diátaxis explanation) (AC10)
...
- Append to the existing array (additive):
  ...
  {"query": "Show me the Acme team's blockers", "should_trigger": false},
