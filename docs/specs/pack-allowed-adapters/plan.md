...
- Goal-based grep: assert `guides/_shared/how-to/install-user-scope-pack-into-kiro.md` exists and contains the substring `agentbundle install --pack`, `--scope user`, `~/.kiro/skills/`.
- Goal-based grep: assert `guides/_shared/how-to/install-user-scope-pack-into-codex.md` exists and contains the substring `agentbundle install --pack`, `--scope user`, `~/.agents/skills/`.
...
- Write `guides/_shared/how-to/install-user-scope-pack-into-kiro.md` per spec AC17 first bullet.
- Write `guides/_shared/how-to/install-user-scope-pack-into-codex.md` per spec AC17 second bullet.
