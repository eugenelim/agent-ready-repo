...
- Document the **corporate** path in `guides/credential-brokers/how-to/add-a-credentialed-skill.md`: `pip install credbroker` from an internal index (`--index-url`) or a local `.whl` — no PyPI required.
