...
- Technical: the canonical quality floor lives at `packs/experience/.apm/skills/design-critique/references/quality-floor.md` (post-rename) and is three-part (states + accessibility + reduced-motion); it stays resident there as the single pack-shared file (see the D2 floor AC build-time correction — a pack-level `references/` dir does not project) (source: that file; RFC-0050 § D2 / § Errata).
